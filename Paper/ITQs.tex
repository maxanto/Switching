...
\begin{enumerate}
	\item Causal entropy vs. non-causal entropy, $H_{BP} \times H_{Val}$
	\item Causal entropy with amplitude contributions vs. non-causal entropy, $H_{BPW} \times H_{Val}$
...
In both information planes $H_{BP} \times C_{BP}$ in in Fig. \ref{fig:HH} and $H_{BP} \times H_{Val}$ in Fig. \ref{fig:HC}), stochastic, chaotic and deterministic data are clearly localized at different planar positions.
