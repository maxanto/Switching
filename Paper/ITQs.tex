...
\item \label{4} an ramdomness quantifier is calculated over desired PDF. In our case we calculate (a) normalyzed Shannon entropy $H$, (b) normalyzed statistical complexity $C$ and (d) MP.
\end{enumerate}
...
\begin{itemize}
\item Given a series $\{x_t, \forall \;  t=0, \Delta t, \cdots,M\Delta t \}$, a sequence of vectors of length $D$ is generated.
