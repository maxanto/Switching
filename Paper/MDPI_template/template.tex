...
% Current address and/or shared authorship $^{\dagger,\ddagger,\S,\|,\P,\dagger\dagger}$
%\firstnote{Facultad de Ingeniería, Universidad Nacional de Mar del Plata, Mar del Plata, Argentina.}
%\secondnote{ICyTE. Instituto de Investigaciones Científicas y Tecnológicas en Electrónica.}
%\thirdnote{CONICET. Consejo Nacional de Investigaciones Científicas y Técnicas.}
%\fourthnote{Departamento de Informática en Salud, Hospital Italiano de Buenos Aires, C1199ABB Ciudad Autónoma de Buenos Aires, Argentina.}
%\fifthnote{Instituto de Física, Universidade Federal de Alagoas (UFAL), Maceió, Brazil.}
%\seventhnote{Facultad de Ingeniería y Ciencias Aplicadas, Universidad de Los Andes, Santiago, Chile.}
%\seventhnote{e}
% The commands \thirdnote{} till \eighthnote{} are available for further notes

% Simple summary
%\simplesumm{zarangundunga cacacaca pedopis}
