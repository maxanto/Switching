...
Figs. \ref{fig:TENT_QuantiB} (a) to (e) show the different quantifiers for floating point and fixed point numerical representation.
...
\begin{figure}
	\includegraphics[width=.49\textwidth]{HbpHval_Tent}
	\includegraphics[width=.49\textwidth]{HbpwHval_Tent}
...
\begin{figure}
	\includegraphics[width=.49\textwidth]{CbpHbp_Tent}
